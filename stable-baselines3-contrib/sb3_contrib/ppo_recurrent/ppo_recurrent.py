...
class RecurrentPPO(OnPolicyAlgorithm):
    ...
    def collect_rollouts(
        ...
        #                                                                      #
        ########################################################################
        new_obs, dones, lstm_states = self._collect_rollouts_fn(env, callback,  rollout_buffer, n_rollout_steps)
    ...
    def _collect_rollouts_default(self, env, callback,  rollout_buffer, n_rollout_steps):
        ...
        # return True
        return new_obs, dones, lstm_states
    ...
    def learn(
        ...
        while cond_():
            print(f"LSTM Iteration ({iteration})...(auturi iteration={self._auturi_iteration})")
